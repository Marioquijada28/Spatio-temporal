...
class(tseries)
plot(tseries, ylab = "Cases", main = "Dengue Cases 2000-2022", col='red', lwd=3)
...
labs(x="Year",y="Cases", main = "Time series of DENV 2000-2022")
...
ggplot() +
  ...
  labs(title = "DENV 2000-2022", x = "Year", y = "Cases") +
